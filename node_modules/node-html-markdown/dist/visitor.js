...
class Visitor {
    ...
    visitNode(node, textOnly, metadata) {
        ...
        if (textOnly || !nodes_1.isElementNode(node))
            return;
        /* Handle element node */
        const translators = (_a = metadata === null || metadata === void 0 ? void 0 : metadata.translators) !== null && _a !== void 0 ? _a : this.instance.translators;
        const translatorCfgOrFactory = translators[node.tagName];
        /* Update metadata with list detail */
        switch (node.tagName) {
            case 'UL':
            case 'OL':
                metadata = Object.assign(Object.assign({}, metadata), { listItemNumber: 0, listKind: node.tagName, indentLevel: ((_b = metadata === null || metadata === void 0 ? void 0 : metadata.indentLevel) !== null && _b !== void 0 ? _b : -1) + 1 });
                break;
            case 'LI':
                if ((metadata === null || metadata === void 0 ? void 0 : metadata.listKind) === 'OL')
                    metadata.listItemNumber = ((_c = metadata.listItemNumber) !== null && _c !== void 0 ? _c : 0) + 1;
                break;
            case 'PRE':
